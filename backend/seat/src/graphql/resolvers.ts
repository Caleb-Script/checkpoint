...
export const resolvers = {
    ...
    Mutation: {
        importSeatMap: async (_: any, args: { file: Promise<FileUpload>, options?: ImportOptions }): Promise<SeatMap> => {
        ...
        pushToCheckpoint: async (_: any, args: { seatMap: string, options: ImportOptions }) => {
