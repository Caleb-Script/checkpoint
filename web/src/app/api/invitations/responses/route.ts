    ...
    try {
        ...
        const items = invitations.map((inv) => {
            ...
            const seatNumber = seat
                ? `${seat.section || ""} ${seat.row || ""} ${seat.number || ""}`.trim() || null
                : null;
            ...
            return {
                ...
                event: { id: inv.event.id, name: inv.event.name, startsAt: inv.event.startsAt, endsAt: inv.event.endsAt },
                guest: {
                    id: gp.id,
                ...
                ticket: ticket
                    ? {
                        ...
                        seat: seat
                            ? { section: seat.section, row: seat.row, number: seat.number, label: seatNumber }
                            : null,
                    }
                    : null,
            };
