...
function cookieOpts(maxAgeSec?: number) {
    ...
    const base = { httpOnly: true as const, sameSite: "lax" as const, secure, path: "/", domain };
...
export async function POST(_req: NextRequest) {
    ...
    const { access_token, refresh_token, expires_in, refresh_expires_in } = json.data.refresh;
